...
import com.mkstecnologia.domain.Authorities;

/**
 * @author Markus Souza on 19/02/2018
 * 
 * A anotação @Configuration que diz ao Spring que essa classe é uma classe de configuração 
 ...
 * A classe possui dois métodos configure: 
 * O primeiro define o gerenciador de autenticação do AuthorizationEndpoint e o segundo registra um Client.
 *
 */
@Configuration
